...
matchStartTimer_Internal( countTime, matchStartTimer )
{
	...
	{
		level thread maps\mp\gametypes\ss::timerStuff();
		level thread maps\mp\gametypes\ss::weaponSwitchLogic(true);
	}
...
endGame( winner, endReasonText, nukeDetonated )
{
	...
	{
		wait 1.5;
		level thread maps\mp\gametypes\oitc::setPlayerRanking();
	}
