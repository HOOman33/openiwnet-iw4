...
main()
{
	...
	//---------------------------------------------------------------------
	// Find all new dlc2 destructibles by their targetnames and run the setup
	//---------------------------------------------------------------------
...
setup_destructibles_dlc2( cached )
{
	if ( !isdefined( cached ) )
		cached = false;
	...
	self.destuctableInfo = common_scripts\_destructible_types_dlc2::makeType_dlc2( self.destructible_type );
	...
	self.targetname = self.targetname + "_dlc2";
